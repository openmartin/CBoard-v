      ...
      <div class="col-md-3">
        <div class="box box-solid">
          ...
          <div class="panel-body">
            <div v-for="datasource in datasourceList" :key="datasource.id" class="datasource-item">
...
export default {
  ...
  components: {
    ...
    ElasticsearchForm: () =>
      import("@/components/config/datasource/ElasticsearchForm"),
  ...
  methods: {
    ...
    del(datasource) {
      this.$confirm("是否删除该数据源？", "提示", {
        ...
        .then(res => {
          this.$req
            .post(this.$api.deleteDatasource, { id: datasource.id })
            .then(value => {
              if (value.status === 200) {
                this.$message({
                  type: "success",
